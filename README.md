...
The site is designed for GitHub Pages and uses plain static HTML/CSS from the repository root.

## Pages

- `index.html` - course landing page
- `syllabus.html` - syllabus and outcomes
...
`https://codewrangler55.github.io/DigitalMediaCourse/`
